...
export const ChapterRow: React.FC<ChapterRowProps> = ({
  ...
  return (
    <>
      ...
      >
        <div className={`flex items-center gap-2.5 ${level === 0 ? 'w-[480px]' : level === 1 ? 'w-[456px]' : 'w-[432px]'} shrink-0 max-md:w-full`}>
          ...
          {hasExternalLink && (
            <svg 
              ...
              className="w-5 h-5 shrink-0 fill-[#116EEE]"
        ...
        <div className="text-[#1E2D40] text-base font-bold leading-6 w-[200px] gap-2 max-md:w-full">
          {lessons}
        </div>
        <div className="text-[#1E2D40] text-base font-bold leading-6 w-[200px] gap-2 max-md:w-full">
          {exercises}
